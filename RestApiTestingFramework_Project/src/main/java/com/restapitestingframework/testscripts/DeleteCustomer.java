...
import com.restapitestingframework.responsepojos.DeleteCustomerResponse;
...
public class DeleteCustomer extends Testbase{
	...
	public void deleteCustomerTest() {
		...
		for (index  = 0; index < indexArray.length; index++) {
			...
			Response response = deleteCustomer(indexArray[index]);

			Gson gson = new Gson();
			deleteCustomerResponse = gson.fromJson(response.asString(), DeleteCustomerResponse.class);
			
			System.out.println(deleteCustomerResponse.getSuccess().getText());
